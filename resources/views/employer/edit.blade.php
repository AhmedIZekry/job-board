        ...
        <form action="{{route('employer.store')}}" method="POST">
            ...
            <div class="mb-4 grid grid-cols-2 gap-4">
                ...
                <div class="col-span-2">
                    ...
                    <textarea class="w-full pr-8 border-gray-300 focus:border-indigo-500 ring-1 focus:ring-indigo-500 rounded-md shadow-sm" name="description" id=""  rows="5">{{$job->description}}</textarea>
                    <x-input-error :message = "$error->get('description')" class="mt-2"/>
                </div>

                <div>
                    <div class="mb-4 font-bold">Experience</div>
                    <x-radio-group name="experience" :options="Opportunity::$experience" @checked('')/>
                </div>
                <div>
